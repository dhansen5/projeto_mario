...
botaoTrailer.addEventListener("click", () => {          //  Quando o botaoTrailer receber um "click", executa:
...
botaoFecharModal.addEventListener("click", () => {      // Quando o botaoFecharModal receber um "click", executa:
    alternarModal();                                    // a função alternarModal();
